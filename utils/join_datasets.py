...
def join_datasets(df_airport, df_weather=None,
    ...
    if df_geography is not None:
        ...
        df_geography_stand_no_dup['stand'] = df_geography_stand_no_dup['stand'].str.upper()
    ...
    if df_aircraft is not None:
        ...
        pairs_rename_aircraft_models['B737-800 WINGLETS'] = '737-800 with winglets'
        ...
        pairs_rename_aircraft_models['B757-200 WINGLETS'] = '757-200, -200PF with winglets'
        pairs_rename_aircraft_models['B787-800 Dreamliner'] = '787-8 Dreamliner'
        ...
        pairs_rename_aircraft_models['B737-700 WINGLETS'] = '737-700 with winglets'
